...
public class RealService extends Service {
    ...
    public RealService() {
        Log.d("immortal", "RealService.ctor");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mainThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (run) {
                    try {
                        Log.d("immortal", "RealService.ping");
    ...
    public void onDestroy() {
        Log.d("immortal", "RealService.onDestroy");
        super.onDestroy();
    ...
    public void onCreate() {
        Log.d("immortal", "RealService.onCreate");
        super.onCreate();
    }

    @Override
    public IBinder onBind(Intent intent) {
        Log.d("immortal", "RealService.onBind");
        return null;
    }

    @Override
    public boolean onUnbind(Intent intent) {
        Log.d("immortal", "RealService.onUnbind");
    ...
    private void sendNotification(String messageBody) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(@(Activity.Package).R.mipmap.icon)
